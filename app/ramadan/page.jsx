...
sharePDF(ref);
    ...
    return (
            <Hadith handleShareImage={handleShareImage} handleSharePDF={handleSharePDF} hadees={hadees} linkToAuthenticateHadith={linkToHadith} totalDonations={0} urduTranslation={urduTranslation} ref={ref} />
