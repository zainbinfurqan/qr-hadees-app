...
export const Hadith = ({handleSharePDF , handleShareImage, hadees, linkToAuthenticateHadith, totalDonations, urduTranslation, ref}) => 
hadees && <div className=" max-w-md rounded overflow-hidden shadow-lg mx-auto p-6 mt-2 bg-green-900 text-center text-white">
      ...
      <div className="flex flex-row  gap-4 justify-end">
         <p>Share</p>
         <p className="cursor-pointer" onClick={handleShareImage}><ImageIcon size={20} /></p>
         <p className="cursor-pointer" onClick={handleSharePDF}><FileText size={20} /></p>
       </div>
      ...
      {hadees?.hadiths && hadees?.hadiths.length >0 && <p>Hadith Number: {hadees?.hadiths[0].hadithnumber}</p>}
       ...
       {<div ref={ref}>
      {hadees?.hadiths && hadees?.hadiths.length >0 && <a href={linkToAuthenticateHadith} target="_blank" rel="noopener noreferrer" className="block">
      ...
      { urduTranslation && 
        <a href={linkToAuthenticateHadith} target="_blank" rel="noopener noreferrer" className="block">
