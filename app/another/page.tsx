...
useEffect(() => {
  ...
  return (
    <>
      ...
      <Hadith handleShareImage={handleShareImage} handleSharePDF={handleSharePDF} hadees={hadees} linkToAuthenticateHadith={linkToHadith} totalDonations={totalDonations} ref={ref} urduTranslation={null} />
    </>
  );
}